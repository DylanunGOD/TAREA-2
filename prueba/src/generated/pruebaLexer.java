...
public class pruebaLexer extends Lexer {
	...
	public static final int
		...
		MENOREQ=27, MAYOREQ=28, ID=29, LITERAL=30, LINE_COMMENT=31, WS=32;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"VAR", "PyCOMA", "ASSIGN", "PIZQ", "PDER", "VIR", "DOSPUNT", "SUM", "SUB", 
			"MUL", "DIV", "MOD", "EQEQ", "NOTEQ", "MENOR", "MAYOR", "MENOREQ", "MAYOREQ", 
			"ID", "LITERAL", "LINE_COMMENT", "WS"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"MENOREQ", "MAYOREQ", "ID", "LITERAL", "LINE_COMMENT", "WS"
		};
	}
